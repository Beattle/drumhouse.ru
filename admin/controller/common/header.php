...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_video_gallery'] = $this->language->get('text_video_gallery');
		$this->data['text_video_category'] = $this->language->get('text_video_category');
		$this->data['text_video'] = $this->language->get('text_video');
		$this->data['text_video_review'] = $this->language->get('text_video_review');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['text_news_gallery'] = $this->language->get('text_news_gallery');

			$this->data['text_news_albums'] = $this->language->get('text_news_albums');
			$this->data['text_news_images'] = $this->language->get('text_news_images');

			$this->data['text_news_install'] = $this->language->get('text_news_install');
			$this->data['text_news_uninstall'] = $this->language->get('text_news_uninstall');
			...
			$this->data['news_install'] = $this->url->link('news/install','token='.$this->session->data['token'],'SSL');
			$this->data['news_uninstall'] = $this->url->link('news/install','token='.$this->session->data['token'],'SSL');
			$this->data['news_albums'] = $this->url->link('news/albums','token='.$this->session->data['token'],'SSL');
			$this->data['news_images'] = $this->url->link('news/images','token='.$this->session->data['token'],'SSL');
            ...
            $this->data['video_category']   = $this->url->link('catalog/video_category', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['video']            = $this->url->link('catalog/video', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['video_review']     = $this->url->link('catalog/video_review', 'token=' . $this->session->data['token'], 'SSL');
