...
class ControllerModuleSimonFilters extends Controller {
    ...
    private $SFs_version = 'simonfilters - 2.12.0 Build 0001';
    ...
    public function index() {
        ...
        if (isset($this->request->post['activefilter_simonfilters_manufacturer_display_mode'])) {
            $this->data['activefilter_simonfilters_manufacturer_display_mode'] = $this->request->post['activefilter_simonfilters_manufacturer_display_mode'];
        } else {
            $this->data['activefilter_simonfilters_manufacturer_display_mode'] = $this->config->get('activefilter_simonfilters_manufacturer_display_mode');
        }
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'GET') {
            ...
            if (file_exists($main_index_filename)) {
                ...
                $VQmodpresent = strpos($main_index_contents, "vqmod.php");
            }
