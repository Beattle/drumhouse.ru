...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	public function getForm() {
    	...
    	if ($this->request->server['REQUEST_METHOD'] == 'POST') {
    	    $order_info = array_merge($order_info, $this->request->post);
    	}
		...
		*/
    	...
    	if (isset($this->request->post['shipping_price'])) {
			...
			$this->data['shipping_price'] = $order_info['shipping_price'];
		} else {
			...
			if ($product_info) {
				...
				*/
				...
				$this->data['order_products'][] = array(
					...
					'total'            => $order_product['price']*$order_product['quantity'], //$order_product['total'],
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->data['cancel'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . $url, 'SSL');
			$this->data['edit'] = $this->url->link('sale/order/update', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
