...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_hit_status_limit'] = $this->language->get('entry_hit_status_limit');
		...
		$this->data['entry_logo_footer'] = $this->language->get('entry_logo_footer');
		...
		$this->data['token'] = $this->session->data['token'];
 		...
 		if (isset($this->error['logoname'])) {
			$this->data['error_logoname'] = $this->error['logoname'];
		} else {
			$this->data['error_logoname'] = '';
		}
		...
		if (isset($this->request->post['config_logoname'])) {
			$this->data['config_logoname'] = $this->request->post['config_logoname'];
		} else {
			$this->data['config_logoname'] = $this->config->get('config_logoname');
		}
		...
		if (isset($this->request->post['config_hit_status_limit'])) {
			$this->data['config_hit_status_limit'] = $this->request->post['config_hit_status_limit'];
		} else {
			$this->data['config_hit_status_limit'] = $this->config->get('config_hit_status_limit');
			if (empty($this->data['config_hit_status_limit']))
			    $this->data['config_hit_status_limit'] = 100;
		}
		...
		if (isset($this->request->post['config_logo_footer'])) {
			$this->data['config_logo_footer'] = $this->request->post['config_logo_footer'];
		} else {
			$this->data['config_logo_footer'] = $this->config->get('config_logo_footer');
		}
		...
		if ($this->config->get('config_logo') && file_exists(DIR_IMAGE . $this->config->get('config_logo')) && is_file(DIR_IMAGE . $this->config->get('config_logo'))) {
			$this->data['logo'] = $this->model_tool_image->resize($this->config->get('config_logo'), 200, 40);
		} else {
			$this->data['logo'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}

		if ($this->config->get('config_logo_footer') && file_exists(DIR_IMAGE . $this->config->get('config_logo_footer')) && is_file(DIR_IMAGE . $this->config->get('config_logo_footer'))) {
			$this->data['logo_footer'] = $this->model_tool_image->resize($this->config->get('config_logo_footer'), 200, 40);
		} else {
			$this->data['logo_footer'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
		...
		if ($this->config->get('config_icon') && file_exists(DIR_IMAGE . $this->config->get('config_icon')) && is_file(DIR_IMAGE . $this->config->get('config_icon'))) {
			...
			$this->data['icon'] = $this->model_tool_image->resize('no_image.jpg', 32, 32);
		}
	...
	private function validate() {
		...
		if (!$this->request->post['config_logoname']) {
			$this->error['logoname'] = 'Надпись под логотипом должно быть от 3 до 64 символов!';
		}	
