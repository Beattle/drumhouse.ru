...
$_['entry_hit_status_limit']	    = 'Пороговое значение для присвоения статуса "Хит продаж":<br /><span class="help">Количество продаж, после которого товар автоматически получает статс "Хит продаж" </span>';
