      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_sales_count; ?></td>
              <td><input type="text" name="sales_count" value="<?php echo $sales_count; ?>" /></td>
            </tr>

            <tr>
              <td><?php echo $entry_status_hit; ?></td>
              <td><?php if ($status_hit) { ?>
                <input type="radio" name="status_hit" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="status_hit" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="status_hit" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="status_hit" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>

            <tr>
              <td><?php echo $entry_status_new; ?></td>
              <td><?php if ($status_new) { ?>
            ...
            <tr>
              <td><?php echo $entry_status_top; ?></td>
              <td><?php if ($status_top) { ?>
                <input type="radio" name="status_top" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="status_top" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="status_top" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="status_top" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              ...
              <td><div class="scrollbox scrollbox_wide">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($categories as $category) { ?>
        ...
        <div id="tab-video">
          <table id="video" class="list">
            <thead>
              <tr>
                <td class="left"><?php echo $entry_preview; ?></td>
            ...
            <tbody id="video-row<?php echo $video_row; ?>">
              <tr>
                <td class="left">
                  <img src="<?php echo $product_video['preview']; ?>" alt="" id="vpreview<?php echo $video_row; ?>" class="image"  width="120" height="90" onclick="image_upload('vimage<?php echo $video_row; ?>', 'vpreview<?php echo $video_row; ?>');" />
                  <input type="hidden" name="product_video[<?php echo $video_row; ?>][image]" value="<?php echo $product_video['image']; ?>" id="vimage<?php echo $video_row; ?>"  />
                </td>
                <td class="left">
                  <input type="text" name="product_video[<?php echo $video_row; ?>][video]" value="<?php echo $product_video['video']; ?>" id="video<?php echo $video_row; ?>" size="20" />
                  <input type="hidden" name="preview_url_<?php echo $video_row; ?>" value="<?php echo $product_video['image']; ?>" id="preview_url_<?php echo $video_row; ?>" size="70" />
                  <a onclick="createPreview(<?php echo $video_row; ?>);" class="button"><span><?php echo $text_preview; ?></span></a>
                </td>
                <td class="left"><a onclick="$('#video-row<?php echo $video_row; ?>').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>
              </tr>
            </tbody>
            <?php $video_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td></td>
                <td></td>
                <td class="left"><a onclick="addVideo();" class="button"><span><?php echo $button_add_video; ?></span></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
<script type="text/javascript"><!--
var video_row = <?php echo $image_row; ?>;

function addVideo() {
    html  = '<tbody id="video-row' + video_row + '">';
	html += '  <tr>';
	html += '    <td class="left">';
    html += '      <input type="hidden" name="product_video[' + video_row + '][image]" value="" id="vimage' + video_row + '" />';
    html += '      <img src="<?php echo $no_image; ?>" alt="" id="vpreview' + video_row + '" class="image"  width="120" height="90" onclick="image_upload(\'vimage' + video_row + '\', \'vpreview' + video_row + '\');" />';
    html += '    </td>';
	html += '    <td class="left">';
    html += '      <input type="text" name="product_video[' + video_row + '][video]" value="" id="video' + video_row + '" size="20" />';
    html += '      <input type="hidden" name="preview_url_' + video_row + '" value="" id="preview_url_' + video_row + '" size="70" />';
    html += '      <a onclick="createPreview(' + video_row + ');" class="button"><span><?php echo $text_preview; ?></span></a>';
    html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#video-row' + video_row  + '\').remove();" class="button"><span><?php echo $button_remove; ?></span></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
<script type="text/javascript"><!--
function createPreview(video_row) {
    var url  = 'http://img.youtube.com/vi/';
    var code = $("#video" + video_row).val();
    //alert(code);

    url = url + code + '/0.jpg';
    $('#preview_url_' + video_row).attr('value', url);
    ...
    $.ajax({
    	...
    	success: function(json) {
            ...
            $('#vpreview' + video_row).attr('src', json['image_url']);
            $('#vimage' + video_row).attr('value', json['image']);
    	},
        error: function(json) {
            alert('error');
    	}
