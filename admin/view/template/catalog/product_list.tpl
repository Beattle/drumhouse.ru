        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'p.model') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php echo $column_hit_new; ?></td>
              ...
              <td class="center"><?php if ($sort == 'p.quantity') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php if ($sort == 'p.sales_count') { ?>
                <a href="<?php echo $sort_sales_count; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sales_count; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_sales_count; ?>"><?php echo $column_sales_count; ?></a>
                <?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td><select name="filter_category_id" style="width: 300px;">
                <option value="*"></option>
              ...
              <td align="center"><input type="text" name="filter_quantity" value="<?php echo $filter_quantity; ?>"  size="8" style="text-align: center;" /></td>
              <td></td>
            ...
            <tr>
              ...
              <td class="center"><?php echo $product['status_hit_new']; ?></td>
              <td class="left">
                  <?php foreach ($categories as $category) { ?>
              ...
              <td class="center"><?php if ($product['quantity'] <= 0) { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php echo $product['sales_count']; ?></td>
