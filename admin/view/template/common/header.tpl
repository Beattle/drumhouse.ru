    ...
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <li><a class="parent"><?php echo $text_video_gallery; ?></a>
          	<ul>
          		<li><a href="<?php echo $video_category; ?>"><?php echo $text_video_category; ?></a></li>
          		<li><a href="<?php echo $video; ?>"><?php echo $text_video; ?></a></li>
          		<li><a href="<?php echo $video_review; ?>"><?php echo $text_video_review; ?></a></li>
          	</ul>
          </li>
