...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
	  ...
	  <!------ change for news compoment------->
	  <li class="news">
	  	<a class="top"><?php echo $text_news; ?></a>
		<?php if($install){?>
			<ul>
				<li><a href="<?php echo $news_install; ?>"><?php echo $text_news_install; ?></a></li>
			</ul>
		...
		<?php }else { ?>
			<ul>
				...
				<li>
					<a class="parent"><?php echo $text_news_gallery; ?></a>
					<ul>
						<li><a href="<?php echo $news_albums; ?>"><?php echo $text_news_albums; ?></a></li>
						<li><a href="<?php echo $news_images; ?>"><?php echo $text_news_images; ?></a></li>
					</ul>
				</li>
				<li><a href="<?php echo $news_uninstall; ?>"><?php echo $text_news_uninstall; ?></a></li>
			</ul>
		<?php }?>
	  </li>
