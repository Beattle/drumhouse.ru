	...
	<div class="box">
		...
		<div class="content">
			...
			<table class="form">
				...
				<td><i><?php echo $data_feed; ?></i> или <i>http://<?=$_SERVER['HTTP_HOST'] ?>/download/yandex_yml.xml</i><br>
				Формирование YML-файла происходит ежедневно в 4:10. Для принудительного формирования, выполните через SSH
				комманду: <i>php /home/dhtime/domains/drumhouse.ru/public_html/export/generate_yml.php</i>
				</td>
				</tr>
			</table>
			</form>
