...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="htabs">
        ...
        <a href="#tab-6"><span>Pro Features</span></a>
    </div>
	...
	<?php foreach ($languages as $language) { ?>
	  ...
	  <td><?php echo $entry_code; ?></td>
          <td><textarea name="cr2htmlmodule_code1_<?php echo $language['language_id']; ?>" cols="120" rows="15"><?php echo isset(${'cr2htmlmodule_code1_' . $language['language_id']}) ? ${'cr2htmlmodule_code1_' . $language['language_id']} : ''; ?></textarea>
	<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
          </td>
        </tr>
	<?php } ?>
	...
	<?php foreach ($languages as $language) { ?>
        <tr>
	  <td><?php echo $entry_code; ?></td>
          <td><textarea name="cr2htmlmodule_code2_<?php echo $language['language_id']; ?>" cols="120" rows="15"><?php echo isset(${'cr2htmlmodule_code2_' . $language['language_id']}) ? ${'cr2htmlmodule_code2_' . $language['language_id']} : ''; ?></textarea>
	<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
          </td>
        </tr>
	<?php } ?>
	...
	<?php foreach ($languages as $language) { ?>
        <tr>
	  <td><?php echo $entry_code; ?></td>
          <td><textarea name="cr2htmlmodule_code3_<?php echo $language['language_id']; ?>" cols="120" rows="15"><?php echo isset(${'cr2htmlmodule_code3_' . $language['language_id']}) ? ${'cr2htmlmodule_code3_' . $language['language_id']} : ''; ?></textarea>
	<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
          </td>
        </tr>
	<?php } ?>
	...
	<td><?php echo $entry_title; ?></td>
	  <td>
	    <input type="text" name="cr2htmlmodule_title4_<?php echo $language['language_id']; ?>" id="cr2htmlmodule_title4_<?php echo $language['language_id']; ?>" size="30" value="<?php echo ${'cr2htmlmodule_title4_' . $language['language_id']}; ?>" />
	    <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
     	  </td>
	</tr>
	<?php } ?>
	<tr>
	  ...
	  <td>
		...
		<label for="cr2htmlmodule_header4_1"><?php echo $entry_yes; ?></label>
		<input type="radio"<?php echo $checked1; ?> id="cr2htmlmodule_header4_1" name="cr2htmlmodule_header4" value="1" />
		<label for="cr2htmlmodule_header4_0"><?php echo $entry_no; ?></label>
		<input type="radio"<?php echo $checked0; ?> id="cr2htmlmodule_header4_0" name="cr2htmlmodule_header4" value="0" />
	  </td>
	</tr>
	...
	<tr>
	  ...
	  <td>
		...
		<label for="cr2htmlmodule_borderless4_1"><?php echo $entry_yes; ?></label>
		<input type="radio"<?php echo $checked1; ?> id="cr2htmlmodule_borderless4_1" name="cr2htmlmodule_borderless4" value="1" />
		<label for="cr2htmlmodule_borderless4_0"><?php echo $entry_no; ?></label>
		<input type="radio"<?php echo $checked0; ?> id="cr2htmlmodule_borderless4_0" name="cr2htmlmodule_borderless4" value="0" />
		<span class="help"><?php echo $entry_borderlesswarn; ?></span>
	  </td>
	</tr>
	...
	<?php foreach ($languages as $language) { ?>
        <tr>
	  <td><?php echo $entry_code; ?></td>
          <td><textarea name="cr2htmlmodule_code4_<?php echo $language['language_id']; ?>" cols="120" rows="15"><?php echo isset(${'cr2htmlmodule_code4_' . $language['language_id']}) ? ${'cr2htmlmodule_code4_' . $language['language_id']} : ''; ?></textarea>
	        <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
          </td>
        </tr>
	<?php } ?>
	...
	<td><?php echo $entry_title; ?></td>
	  <td>
	    <input type="text" name="cr2htmlmodule_title5_<?php echo $language['language_id']; ?>" id="cr2htmlmodule_title5_<?php echo $language['language_id']; ?>" size="30" value="<?php echo ${'cr2htmlmodule_title5_' . $language['language_id']}; ?>" />
	    <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
      </td>
	</tr>
	<?php } ?>
	<tr>
	  ...
	  <td>
		...
		<label for="cr2htmlmodule_header5_1"><?php echo $entry_yes; ?></label>
		<input type="radio"<?php echo $checked1; ?> id="cr2htmlmodule_header5_1" name="cr2htmlmodule_header5" value="1" />
		<label for="cr2htmlmodule_header5_0"><?php echo $entry_no; ?></label>
		<input type="radio"<?php echo $checked0; ?> id="cr2htmlmodule_header5_0" name="cr2htmlmodule_header5" value="0" />
	  </td>
	</tr>
	...
	<tr>
	  ...
	  <td>
		...
		<label for="cr2htmlmodule_borderless5_1"><?php echo $entry_yes; ?></label>
		<input type="radio"<?php echo $checked1; ?> id="cr2htmlmodule_borderless5_1" name="cr2htmlmodule_borderless5" value="1" />
		<label for="cr2htmlmodule_borderless5_0"><?php echo $entry_no; ?></label>
		<input type="radio"<?php echo $checked0; ?> id="cr2htmlmodule_borderless5_0" name="cr2htmlmodule_borderless5" value="0" />
		<span class="help"><?php echo $entry_borderlesswarn; ?></span>
	  </td>
	</tr>
	...
	<?php foreach ($languages as $language) { ?>
        <tr>
	  <td><?php echo $entry_code; ?></td>
          <td><textarea name="cr2htmlmodule_code5_<?php echo $language['language_id']; ?>" cols="120" rows="15"><?php echo isset(${'cr2htmlmodule_code5_' . $language['language_id']}) ? ${'cr2htmlmodule_code5_' . $language['language_id']} : ''; ?></textarea>
	        <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align: top;" /><br />
          </td>
        </tr>
	<?php } ?>
    ...
    <div id="tab-6" style="clear: both; font-size: 1.2em;">
    <ul>
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="cr2htmlmodule_module[' + module_row + '][area_id]" > <?php for ($i=1; $i<=5; $i++) { ?><option value="area<?php echo $i;?>">Area <?php echo $i; ?></option><?php }; ?> </td>';
