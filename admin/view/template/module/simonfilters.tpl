                        ...
                        <div id="tab-filters" style="display:">
                            ...
                            <div id="tab-manufacturers">
                                <table class="attr_item">
                                    ...
                                    <tr>
                                        <td>Display mode<span class="help">Choose "normal" to show all, "more/less" button or scrollbar and the number of products needed to show the button or scrollbar.</td>
                                        <td>
                                            <select name="activefilter_simonfilters_manufacturer_display_mode[more]">
                                                <option value="0" <?php if(isset($activefilter_simonfilters_manufacturer_display_mode['more']) && $activefilter_simonfilters_manufacturer_display_mode['more']=='0') echo " SELECTED" ?>>Normal</option>
                                                <option value="1" <?php if(isset($activefilter_simonfilters_manufacturer_display_mode['more']) && $activefilter_simonfilters_manufacturer_display_mode['more']=='1') echo " SELECTED" ?>>more.../less...</option>
                                                <option value="2" <?php if(isset($activefilter_simonfilters_manufacturer_display_mode['more']) && $activefilter_simonfilters_manufacturer_display_mode['more']=='2') echo " SELECTED" ?>>Scrollbar</option>
                                            </select>
                                            <input type="text" name="activefilter_simonfilters_manufacturer_display_mode[more_number]" value="<?php echo isset($activefilter_simonfilters_manufacturer_display_mode['more_number'])?$activefilter_simonfilters_manufacturer_display_mode['more_number']:4;?>">
                                        </td>
                                    </tr>
                                    <tr>
