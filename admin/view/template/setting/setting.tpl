      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> Надпись под логотипом</td>
              <td><input type="text" name="config_logoname" value="<?php echo $config_logoname; ?>" size="40" />
                <?php if ($error_logoname) { ?>
                <span class="error"><?php echo $error_logoname; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
        ...
        <div id="tab-option">
          <table class="form">
            ...
            <tr style="background-color: #FFFF98;">
              <td><span class="required">*</span> <?php echo $entry_hit_status_limit; ?></td>
              <td><input type="text" name="config_hit_status_limit" value="<?php echo $config_hit_status_limit; ?>" size="3" />
            </tr>
        ...
        <div id="tab-image">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_logo_footer; ?></td>
              <td><input type="hidden" name="config_logo_footer" value="<?php echo $config_logo_footer; ?>" id="logo_footer" />
                <img src="<?php echo $logo_footer; ?>" alt="" id="preview-logo_footer" class="image" onclick="image_upload('logo_footer', 'preview-logo_footer');" /></td>
            </tr>
            <tr>
