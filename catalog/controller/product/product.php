...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $this->data['total_images'] = count($this->data['images']);
			...
			foreach ($results as $result) {
				$this->data['videos'][] = array(
					'code'  => $result['video'],
                    'href'  => 'http://www.youtube.com/watch?v=' . $result['video'],
					'thumb' => $this->model_tool_image->resize($result['image'], 150, 112)
				);
			}
            $this->data['total_videos'] = count($this->data['videos']);
