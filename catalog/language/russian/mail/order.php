<?php
// Text
$_['text_new_subject']          = '%s - заказ %s'; // Благодарим за интерес к товарам Магазина музыкальных инструментов Drumhouse.ru.
$_['text_new_greeting']         = 'Благодарим за интерес к товарам %s. Ваш заказ получен, в ближайшее время с Вами свяжется менеджер.';
...
$_['text_new_powered']			= 'Работает на <a href="http://myopencart.ru">OpenCart</a><br /> %s &copy; %s';
