...
class ModelCatalogSimonFilters extends Model {
    ...
    public function isActive() {
        ...
        if(is_array($this->config->get("simonfilters_module"))) {
...
#toslider#$data['o'][$row['group_id']][$row['group_id']]['sort_order'] = $row['sort_order'];
            ...
            if (count($activefilter_simonfilters_manufacturer) > 0) {
                ...
                $activefilter_simonfilters_manufacturer_display_mode = $this->config->get("activefilter_simonfilters_manufacturer_display_mode");
                ...
                foreach ($query->rows as $row) {
                    ...
                    $data['m'][$row['group_id']]['more'] = $activefilter_simonfilters_manufacturer_display_mode['more'];
                    $data['m'][$row['group_id']]['more_number'] = $activefilter_simonfilters_manufacturer_display_mode['more_number'];
                }
                if ($query->num_rows) {
