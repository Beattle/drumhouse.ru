...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-list">
    ...
    <div>
      ...
      <div class="image"><a href="<?php echo $product['href']; ?>"><img id="image<?php echo $product['product_id']; ?>" src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
      <?php } ?>
